...
namespace SpaceTypeFunctionTemplate
{
    public class Function
    {
        ...
        private IModelStore<SpaceTypeFunctionTemplateInputs> store;

        public async Task<SpaceTypeFunctionTemplateOutputs> Handler(SpaceTypeFunctionTemplateInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<SpaceTypeFunctionTemplateInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<SpaceTypeFunctionTemplateInputs,SpaceTypeFunctionTemplateOutputs>(store, SpaceTypeFunctionTemplate.Execute);
